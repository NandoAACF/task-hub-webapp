...
export default function CardTodo({
    ...
    return (
        <div className="flex flex-row flex-wrap items-center justify-start rounded-xl bg-slate-200 w-full h-[117px] py-[10px] px-[20px] relative hover:scale-105 transition-all ease-in-out duration-200">
